...
@Composable
fun AddItemComponent(navController: NavController, itemType: String,folderId: Int?,flashcardId: Int?, onFolderSelected: ((Int) -> Unit)? = null, onFlashcardSelected: (() -> Unit)? = null) {    var expanded by remember { mutableStateOf(false) }
            ...
            DropdownMenu(
                ...
                MenuItem(text = "Add $itemType") {
                    when (itemType) {
                        ...
                        "Flashcard" -> {
                            // Hiển thị folderId trong logcat
